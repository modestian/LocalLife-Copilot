...
from app.analytics import SentimentAnalyzer, SentimentClassifier, AspectExtractor
...
=======
    print(f"  Text {i}: sentiment={r.sentiment}, confidence={r.confidence}, aspects={r.aspect_labels}, reasons={r.negative_reason}")
>>>>>>> 2ae14b5 (feat:TK-401-04 特征与归因提取、结果持久化  TK-401-06 离线模型评测)
